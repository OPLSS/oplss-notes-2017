...
-- Exercise: Extend this implementation so that it will run forever,
-- as a total program.

-- Hint: ATMCmd programs should be *terminating*, but you'll need to
-- add a driver which loops forever, invoking alt_alt on each iteration
